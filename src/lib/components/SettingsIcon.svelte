<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="-50 -50 100 100">
	<defs>
		<path
			id="cog"
			d="M48,0 A48,48 0 0 1 45.6507,14.8328 L38.0423,12.3607 A40,40 0 0 1 32.3607,23.5114 L38.8328,28.2137"
			stroke-width="4"
	...
	<g id="settings" style="display: inline;">
		...
		<circle r="18.334368540005052" stroke-width="4" fill="none" />
	</g>
</svg>
